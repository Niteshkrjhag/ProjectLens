# maintenance and docs refresh — Normal operating case — version 3

Fixture path: light-day/general/version 3  
Captured: 2026-08-28  
...
The review record confirms the plan remains inside $6,500. The team will protect the 2026-09-04 delivery window and record any change as a new source.

## Relevant facts

- Workstream: maintenance and docs refresh
- Delivery window: 2026-09-04
- Expected measure: new engineers reach a green local build in under 30 minutes
- Dependency: the current starter repository
- Commercial context: $6,500
