# maintenance and docs refresh — Normal operating case — version 1

- Fixture: light-day/general/version 1
- Domain: Atlas migration portfolio
- Document type: Requirements / PRD
- Owner: Samira Ali · Developer Experience
- Decision date: 2026-08-03

## Intent

The approved objective is to refresh the onboarding runbook and remove three stale local-development steps. Success is measured by new engineers reach a green local build in under 30 minutes.
