# CSV importer retirement — Unusual / adversarial case — version 1

Fixture path: simple/odd/version 1  
Captured: 2026-08-03  
...
A source received on 2026-08-03 claims the objective is to replace the legacy vendor CSV upload with a signed JSON drop, but its appendix calls for a different cutoff. The analyst must preserve both claims and surface the contradiction.
