# mobile release pipeline — Normal operating case — version 1

- Fixture: medium/general/version 1
- Domain: Atlas migration portfolio
- Document type: Requirements / PRD
- Owner: Rohan Patel · Release Engineering
- Decision date: 2026-08-03

## Intent

The approved objective is to move the Android and iOS builds to a shared, reproducible CI pipeline. Success is measured by 95% of release builds complete under 14 minutes.
